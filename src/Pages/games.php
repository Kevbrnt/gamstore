            ...
            <div class="articles-container grid-cols-5">
                ...
                if (count($games) > 0) {
                    foreach ($games as $row) {
                        ...
                        $nameGame = htmlspecialchars($row['name']);
                        $idGame = htmlspecialchars($row['id']);
                        ...
                        echo "<img src='{$imageUrl}' alt='{$nameGame}' class='product-image' data-toggle='modal' data-target='#detailsModal{$idGame}' />";
                        echo "</div>";

                        // Modal pour chaque jeu
                        echo "<div class='modal fade' id='detailsModal{$idGame}' tabindex='-1' role='dialog' aria-labelledby='detailsModalLabel{$idGame}' aria-hidden='true'>";
                        echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                        echo "<div class='modal-content'>";
                        echo "<div class='modal-header'>";
                        echo "<h5 class='modal-title' id='detailsModalLabel{$idGame}'>{$nameGame}</h5>";
                        echo "<button type='button' class='close' data-dismiss='modal' aria-label='Close'>";
                        echo "<span aria-hidden='true'>&times;</span>";
                        echo "</button>";
                        echo "</div>";
                        echo "<div class='modal-body'>";
                        echo "<img src='{$imageUrl}' class='card-img-top' alt='{$nameGame}' />";
                        ...
                        if ($isLoggedIn && !$isOutOfStock) {
                            echo "<button class='btn btn-primary addToCartBtn' data-game-id='{$idGame}'>Ajouter au panier</button>";
                        } elseif ($isLoggedIn) {
