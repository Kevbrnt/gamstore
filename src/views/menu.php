    ...
    if(isset($_SESSION['id'])){
        ...
        if($user_role == 'Administrateur'){ ?>
            <div>
                ...
                ">
                            <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/Accueil.php">Acceuil</a></li>
                            <li class="py-2 px-4 rounded-lg text-center"><a class="nav-link" href="../../src/controllers/espace_admin.php">Espace Admin</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <?php } else if ($user_role == 'Visiteur'){ ?>
            <div class="menuPrincipal">
                ...
                ">
                            <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/Accueil.php">Acceuil</a></li>
                            <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/games.php">Tous les jeux</a></li>
                            <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/cart.php">Mon panier <span id="cart-count">0</span></a></li>
                            <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/espace.php">Mon espace</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <?php } elseif ($user_role == 'Employés') { ?>
            <div>
                ...
                ">
                            <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/Accueil.php">Acceuil</a></li>
                            <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/espace_employés.php">Menu Employés</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div>
            <div id="navbar" class="bg-slate-800 text-white flex justify-between items-center flex-wrap ">
                ...
                ">
                        <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/Accueil.php">Acceuil</a></li>
                        <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/games.php">Tous les jeux</a></li>
                        <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/register.php">Inscription</a></li>
                        <li class="py-2 px-4 rounded-lg text-center"><a href="../../src/controllers/login.php">Connexion</a></li>
                    </ul>
                </div>
            </div>
        </div>
