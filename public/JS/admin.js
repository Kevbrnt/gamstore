$(document).ready(function() {
    ...
    $('#create-game-form').on('submit', function(event) {
        ...
        $.ajax({
            url: '../../src/controllers/create_game.php',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $('#manage-stock-form').on('submit', function(event) {
        ...
        $.ajax({
            url: '../../src/controllers/manage_stock.php',
            type: 'POST',
            data: $(this).serialize(),
            success: function(response) {
                var result = JSON.parse(response);
    ...
    $(document).ready(function() {
        $('#add-employee-form').on('submit', function(event) {
            ...
            $.ajax({
                url: '../../src/views/load_employes.php',
                type: 'POST',
                data: $(this).serialize(),
                success: function(response) {
    ...
    $('#salesDashboardModal').on('show.bs.modal', function() {
        $.ajax({
            url: '../../src/controllers/dashboard.php',
            type: 'GET',
            success: function(response) {
                var result = JSON.parse(response);
                if (result.success) {
